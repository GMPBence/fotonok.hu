    ...
    <div className="flex bg-primary flex-col items-center justify-center h-screen">
      <div className="bg-[#1F243280] sm:w-150.5 h-110 p-10 flex flex-col rounded-2xl gap-5">
        ...
        <div className="flex flex-row gap-2">
          ...
          />
          <label htmlFor="aszf" className="text-white"><span className="text-red-600">*</span>Elfogadom az <a href="https://fotonok.hu/docs/aszf.pdf" target="_blank" rel="noopener noreferrer" className="text-blue-500" title="Általános szerződési feltételek">ÁSZF</a>-et, és az <a href="https://fotonok.hu/docs/at.pdf" target="_blank" rel="noopener noreferrer" className="text-blue-500" title="Adatvédelmi tájékoztató">AT</a>-t</label>
        </div>
